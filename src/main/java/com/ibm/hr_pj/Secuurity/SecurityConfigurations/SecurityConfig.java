...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .hasAuthority("MEDSUP")
                .requestMatchers("/HR/dashboard/page","/hr/overdue/leaves/table","/hr/ended/leaves/table","/hr/all/employees/table","/hr/employees/on/leave/table","/hr/employees/searchPage","/hr/employees/editPage")
                .hasAuthority("HR")
                .anyRequest()
                .authenticated()
                .and()
